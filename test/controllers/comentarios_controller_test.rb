...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: {  conteudo: @comentario. conteudo, comentavel_id: @comentario.comentavel_id, comentavel_type: @comentario.comentavel_type }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: {  conteudo: @comentario. conteudo, comentavel_id: @comentario.comentavel_id, comentavel_type: @comentario.comentavel_type }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
